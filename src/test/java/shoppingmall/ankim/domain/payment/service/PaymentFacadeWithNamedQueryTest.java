...
class PaymentFacadeWithNamedQueryTest {
    @MockBean
    ...
    @Autowired
    private PaymentFacadeWithNamedQuery paymentFacadeWithNamedQuery;
    ...
    void requestTossPayment_withOrderFactory() {
        ...
        // when
        PaymentResponse response = paymentFacadeWithNamedQuery.createPaymentWithNamedQuery(request,deliveryRequest,addressRequest);
    ...
    """, order.getOrdNo());
        ...
        // when
        PaymentSuccessResponse response = paymentFacadeWithNamedQuery.toSuccessRequestWithNamedQuery(paymentKey, order.getOrdNo(), amount);
    ...
    void tossPaymentFail_shouldReturnPaymentFailResponse() {
        ...
        // when
        PaymentFailResponse failResponse = paymentFacadeWithNamedQuery.toFailRequestWithNamedQuery(errorCode, errorMessage, orderId);
    ...
    """;
        ...
        // when
        PaymentCancelResponse response = paymentFacadeWithNamedQuery.toCancelRequestWithNamedQuery(paymentKey, cancelReason);
...
//    @Test
//    @Transactional
//    @DisplayName("결제 실패 시 재고 복구를 할 떄 복구 수량이 0보다 작을 경우 예외 발생가 발생한다.")
//    void tossPaymentFail_restoreStockFail_shouldThrowException() {
//        // given
//        String orderCode = "ORD20241125-1234567";
//        String errorCode = "ERR001";
//        String errorMessage = "결제 실패";
//
//        // Order와 Payment 데이터 생성 및 저장
//        Order order = OrderFactory.createOrderWithInvalidStockQuantityException(entityManager);
//        order.setOrdCode(orderCode);
//        orderRepository.save(order);
//
//
...
//
//        // when & then
//        InvalidStockQuantityException exception = assertThrows(
//                InvalidStockQuantityException.class,
//                () -> paymentFacadeWithNamedQuery.toFailRequestWithNamedQuery(errorCode, errorMessage, orderId)
//        );
//
//        // 예외 메시지 검증
//        assertThat(exception.getMessage()).isEqualTo("복구할 재고 수량은 0보다 커야 합니다.");
//    }
//
//    @Test
//    @Transactional
//    @DisplayName("결제 취소 시 재고 복구를 할 떄 복구 수량이 0보다 작을 경우 예외 발생가 발생한다.")
//    void cancelPayment_restoreStockFail_shouldThrowException() {
//        // given
//        String paymentKey = "test_payment_key";
//        String cancelReason = "사용자 요청";
//        String orderCode = "ORD20241125-1234567";
