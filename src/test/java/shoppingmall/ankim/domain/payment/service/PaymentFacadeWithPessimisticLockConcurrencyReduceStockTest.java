        ...
        for (int i = 0; i < threadCount; i++) {
            ...
            executorService.submit(() -> {
                try {
                    ...
                    PaymentResponse paymentWithSynchronized = paymentFacadeWithPessimisticLock.createPaymentWithPessimisticLock(paymentRequest, deliveryRequest, addressRequest);
                } catch (Exception e) {
                    e.printStackTrace();
                } finally {
                    latch.countDown();
