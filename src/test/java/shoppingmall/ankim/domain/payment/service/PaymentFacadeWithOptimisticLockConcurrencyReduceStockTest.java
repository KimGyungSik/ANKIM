...
public class PaymentFacadeWithOptimisticLockConcurrencyReduceStockTest {
    @MockBean
...
//                    paymentFacadeWithOptimisticLock.createPaymentWithOptimisticLock(paymentRequest, deliveryRequest, addressRequest);
                } catch (Exception e) {
