...
public class PaymentFacadeWithRedis {
    ...
    public PaymentResponse createPaymentWithRedis(PaymentCreateServiceRequest request,
    ...
    public PaymentSuccessResponse toSuccessRequestWithRedis(String paymentKey, String orderId, Integer amount) {
        // 주문상태를 결제완료로 수정
    ...
    public PaymentFailResponse toFailRequestWithRedis(String code, String message, String orderId) {
    ...
    public PaymentCancelResponse toCancelRequestWithRedis(String paymentKey, String cancelReason) {
    ...
    private void reduceStock(Order order) {
        for (OrderItem orderItem : order.getOrderItems()) {
            ...
            try {
                ...
                // 락 해제
                lockHandler.unlockWithRedisson(key);
            }
        }
    }
