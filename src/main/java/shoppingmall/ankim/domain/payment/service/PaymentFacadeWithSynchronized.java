...
public class PaymentFacadeWithSynchronized {
    ...
    public PaymentResponse createPaymentWithSynchronized(PaymentCreateServiceRequest request,
    ...
    public PaymentSuccessResponse toSuccessRequestWithSynchronized(String paymentKey, String orderId, Integer amount) {
        // 주문상태를 결제완료로 수정
    ...
    public PaymentFailResponse toFailRequestWithSynchronized(String code, String message, String orderId) {
    ...
    public PaymentCancelResponse toCancelRequestWithSynchronized(String paymentKey, String cancelReason) {
